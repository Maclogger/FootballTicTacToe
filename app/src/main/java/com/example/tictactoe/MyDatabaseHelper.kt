...
class MyDatabaseHelper(private val context: Context, private val allTeamNames: ArrayList<String>) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    companion object {
